...
export default function InputKaryawan(){
    ...
    async function handleSubmit(e){
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:3000/karyawan/`, reqBody)
            console.log(response, "<<<<<<");
            Swal.fire({
                title: "Good job!",
                text: "Employee berhasil diinput",
                icon: "success"
            });
            navigate("/employee")
        } catch (error) {
    ...
    return (
        <form onSubmit={handleSubmit} className="mx-auto p-8 w-full">
            <h1 className="text-3xl mb-2">Add Employee Form</h1>
            <div className="mb-5">
            ...
            <div className="mb-5">
                ...
                <div className="flex items-center mb-4">
                    <input id="gender-l" type="radio" name="gender" value="L" onChange={e => setGender(e.target.value)} className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300"/>
                    <label htmlFor="gender-l" className="block ms-2  text-sm font-medium text-gray-900">
                    Laki-laki
                    </label>
                </div>
                <div className="flex items-center mb-4">
                    <input id="gender-p" type="radio" name="gender" value="P" onChange={e => setGender(e.target.value)} className="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300"/>
